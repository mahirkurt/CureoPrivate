...
>
> **Sürüm 3.8.4 (2026-08-16/17):** Claude Code `plugin.json` `agents` alanı dizin stringi (`"./agents"`) değil, ajan `.md` dosya listesi — CLI `agents: Invalid input` ile 3.8.3 paketini yüklemiyordu; `agents/` yine konvansiyonla keşfedilir, bildirim şimdi doğrulayıcının kabul ettiği biçimde. Türk Patent wire'ı emekli (ölü Capsolver upstream) → filo 22 server (19 gated / 3 public).
>
