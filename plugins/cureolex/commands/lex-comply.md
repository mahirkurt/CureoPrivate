...
`cureolex` flagship skill'ini **Mod 4 COMPLY** olarak çalıştır. Rubrik: [`references/06b-compliance-executable-rubric.md`](../skills/cureolex/references/06b-compliance-executable-rubric.md).
