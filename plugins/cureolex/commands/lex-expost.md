...
`cureolex` flagship skill'ini **Mod 9 EX_POST_EVALUATION** olarak çalıştır. Template: [[`templates/ex-post-evaluation.md`](../skills/cureolex/templates/ex-post-evaluation.md)](../skills/cureolex/templates/ex-post-evaluation.md).
