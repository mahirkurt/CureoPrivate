...
3. **Uluslararası insan hakları** süzgeci:
   ...
   - Oviedo Sözleşmesi uyumu (`coe_treaty_signatories` CETS 164 snapshot; TR onay uydurulmaz)
...
**Bu rubric, Cureolex v2.3 Mod 4 (COMPLY) çıktılarının tekrar üretilebilir, objektif ve operasyonel olmasını sağlar. R6 (descriptive) ile birlikte kullanılır; her kontrolün ne olduğunu R6, nasıl ölçüldüğünü ve sapma halinde ne yapılacağını R6b sağlar.**
