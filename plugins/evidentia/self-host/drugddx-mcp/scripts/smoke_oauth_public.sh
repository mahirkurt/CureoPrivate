#!/usr/bin/env bash
# smoke_oauth_public.sh — post-deploy smoke test for drugddx-mcp.
...
#
# Usage:
#   BASE=https://drugddx-mcp.<your-subdomain>.workers.dev MCP_API_KEY=<key> ./scripts/smoke_oauth_public.sh
set -euo pipefail
