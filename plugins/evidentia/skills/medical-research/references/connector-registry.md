...
| **Social Listening** | `socius-vigil-mcp.cureonics.workers.dev` | Backing connector for the OSINT axis | `osint-playbook.md`; social/PV-signal triage only (Tier 6). Conditional/quota-aware |
