...
>
> **Sürüm 3.8.4 (2026-08-16):** Claude Code `plugin.json` `agents` alanı dizin stringi (`"./agents"`) değil, ajan `.md` dosya listesi — CLI `agents: Invalid input` ile 3.8.3 paketini yüklemiyordu; `agents/` yine konvansiyonla keşfedilir, bildirim şimdi doğrulayıcının kabul ettiği biçimde.
>
