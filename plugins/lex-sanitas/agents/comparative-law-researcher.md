...
tools: Read, Grep, Glob, WebFetch, mcp__plugin_lex-sanitas_health-policy__*, mcp__health-policy__*, mcp__claude_ai_Health_Policy__*, mcp__plugin_lex-sanitas_german-law__*, mcp__german-law__*, mcp__claude_ai_german-law__*, mcp__claude_ai_German_Law__*, mcp__plugin_lex-sanitas_ich-guidelines__*, mcp__ich-guidelines__*, mcp__claude_ai_ich-guidelines__*, mcp__plugin_lex-sanitas_intl-treaty__*, mcp__intl-treaty__*, mcp__claude_ai_International_Treaty__*, mcp__plugin_lex-sanitas_eudamed__*, mcp__eudamed__*, mcp__claude_ai_eudamed__*, mcp__plugin_lex-sanitas_oecd__*, mcp__oecd__*, mcp__claude_ai_oecd__*, mcp__plugin_lex-sanitas_openathens__*, mcp__openathens__*, mcp__claude_ai_openathens__*, mcp__claude_ai_Openathens__*, mcp__plugin_lex-sanitas_annas-reader__*, mcp__annas-reader__*, mcp__claude_ai_annas-reader__*, mcp__claude_ai_Annas_Reader__*, mcp__plugin_lex-sanitas_eurlex__*, mcp__eurlex__*, mcp__claude_ai_eurlex__*, mcp__claude_ai_Eurlex__*, mcp__plugin_lex-sanitas_fedlex__*, mcp__fedlex__*, mcp__claude_ai_fedlex__*, mcp__claude_ai_Fedlex__*, mcp__plugin_lex-sanitas_uk-legal__*, mcp__uk-legal__*, mcp__claude_ai_uk-legal__*, mcp__claude_ai_Uk_Legal__*, mcp__plugin_lex-sanitas_turk-patent__*, mcp__turk-patent__*, mcp__claude_ai_turk-patent__*, mcp__claude_ai_Turk_Patent__*, mcp__plugin_lex-sanitas_anamnesis__*, mcp__anamnesis__*, mcp__claude_ai_anamnesis__*, mcp__claude_ai_Anamnesis__*, mcp__Yarg__*, mcp__claude_ai_Yarg__*, mcp__Open_Law__*, mcp__claude_ai_Open_Law__*, mcp__Ansvar__*, mcp__claude_ai_Ansvar__*
# GEN:agent-tools END
---
...
3. **Tam-filo yabancı katmanını süpür** (hepsi, sırayla): `mcp__health-policy__*` (semantik sonuçları fetch ile doğrula: `federal_register_search`/`ecfr_get`/`japan_elaws_fetch`/`australia_legislation_fetch`/`canada_justicelaws_fetch`/`spain_boe_fetch`/`mexico_dof_nota`/`china_law_detail`/`ireland_eisb_fetch`) · `mcp__german-law__*` · `mcp__ich-guidelines__*` · `mcp__intl-treaty__*` · `mcp__eudamed__*` · bağlıysa `mcp__Open_Law__*` + `mcp__Ansvar__*` · bağlıysa **`mcp__fedlex__*`** (CH kapsamdaysa İsviçre birincil metni: `search_by_title` → `get_law_text`/`get_article` → `list_amendments`; SR numarası kimliktir — Ansvar CH bulgusu çerçeve-teyit, çatışmada Fedlex kazanır; CH kapsam dışıysa coverage'a `skipped: mod için N/A` yaz) · `mcp__oecd__*`. TR karşı-tarafı için `mcp__mevzuat__*` + bağlıysa `mcp__Yarg__*`. (Önek notu: claude.ai connector önekleri yüzeye göre `mcp__<Ad>__*` / `mcp__claude_ai_<Ad>__*` görünebilir — ada göre eşleştir.)
