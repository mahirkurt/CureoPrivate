...
- **Fedlex Swiss** (`mcp__fedlex__*`, bağlıysa) — 🇨🇭 İsviçre federal hukuku resmî portalı; CH birincil-metin sorularında zorunlu: `search_by_title` → `get_law_text`/`get_article` → `list_amendments`. SR numarası identifier'dır.
