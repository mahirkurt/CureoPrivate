...
- **Türk Patent** (`mcp__turk-patent__*`, bağlıysa) — TR sınai-mülkiyet registry (patent/marka/tasarım arama+detay); konu IP-boyutluysa (ilaç patenti/SPC/veri imtiyazı/patent linkage/6769 SMK) çağır, IP-boyut yoksa coverage'a `skipped: mod için N/A` yaz (satır sessizce düşmez).
