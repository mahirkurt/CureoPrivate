...
2. **Tam-filo (G0, zorunlu).** `references/00-mod-pipelines.md` Mod 1 server-listesini `legal-distiller` alt-ajanına tek görevde ver; wire'lı 23 MCP + bağlı companion **tamamı** süpürülsün, kompakt `retrieval_distillate` + `coverage` dönsün.
