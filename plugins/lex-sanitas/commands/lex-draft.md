...
2. **Tam-filo (G0, zorunlu).** `references/00-mod-pipelines.md` Mod 1 server-listesini `legal-distiller` alt-ajanına tek görevde ver; wire'lı 14 MCP + bağlı companion **tamamı** süpürülsün, kompakt `retrieval_distillate` + `coverage` dönsün.
...
5. **Template:** `templates/yonetmelik-taslagi.md` veya `templates/teblig-taslagi.md`. Gerekçe: `templates/genel-gerekce.md` + `templates/madde-gerekce.md`.
