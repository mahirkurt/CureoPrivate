#!/usr/bin/env python3
"""lex-sanitas canlı filo prob'u — YALNIZ stdlib, fail-open, 24 saat cache'li.
...
USER_AGENT = "lex-sanitas-preflight/3.5.0 (+https://cureonics.com)"
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="lex-sanitas canlı filo prob'u")
