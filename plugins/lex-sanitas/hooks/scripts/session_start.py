...
CONVENTIONS = (
    ...
    "KOŞULLU companion'lar (bağlıyken İLGİLİ bağlam tetiklenince zorunlu): Fedlex Swiss (Mod7 CH "
    "birincil metin — Ansvar CH satırı çerçeve-teyide düşer), YokTez (tez doktrini + G7 YÖK-Tez atıf "
    "doğrulama), Türk Patent (IP-boyutlu reform: ilaç patenti/SPC/veri imtiyazı). Connector önekleri "
    "yüzeye göre mcp__<Ad>__* veya mcp__claude_ai_<Ad>__* görünebilir — ada göre eşleştir. "
