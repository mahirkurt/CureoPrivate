...
Bu dosya, Mevzuat MCP'nin 12 tool'unun mod bazlı **somut kullanım örüntülerini** içerir.

## 1. Mevzuat MCP Tool Envanteri (Yeniden)

| Tool | Parametreler | Çıktı |
|------|--------------|-------|
| `search_mevzuat` | query, (sayfalama) | Aday liste |
...
| `get_mevzuat_content` | iframe URL | Düz metin + parsed madde |
