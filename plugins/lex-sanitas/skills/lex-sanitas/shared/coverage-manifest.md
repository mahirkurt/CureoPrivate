...
- Wire edilmiş **23 MCP** + **3 companion** (Yarg/Open_Law/Ansvar/Fedlex_Swiss/Turk_Patent — satırları HER manifestoda zorunlu, bağlı olsun olmasın) + **evidentia** (klinik-boyut varsa) + **sci-audit** (her çıktı) için **birer satır**.
