...
{{Türkiye'nin taraf olduğu uluslararası sözleşmeler: ICESCR Md. 12, 
CRC Md. 24, CRPD Md. 25, AİHS, Oviedo Sözleşmesi (varsa), WHO 
Çerçeve Sözleşmeleri, vd. ile uyum gerekçesi. Bkz. references/10}}
...
## Bölüm I — Lex-Sanitas v2.6.0 Kalite Kontrol Notu

Bu kanun teklifi, Lex-Sanitas v2.6.0 protokolü uyarınca aşağıdaki kalite kapılarından geçirilmiştir:
...
**Bilgi sınırı uyarısı:** Bu şablon, lex-sanitas v2.6.0'in **standalone protokolü** olarak hazırlanmıştır. TBMM Başkanlığına fiilî sunum öncesinde, **Anayasa Dili ve Kanun Yazılış Tekniği Heyeti'nin** (İçtüz. Md. 85) önerebileceği şekli düzeltmeler dikkate alınmalıdır.

---

**Bu şablon, Lex-Sanitas v2.6.0'in TBMM Kanun Teklifi modunun (Mod 8) operasyonel iskeletidir. Kullanım için Mod 8 protokolüne (SKILL.md Bölüm 6.8) başvurun.**
