...
`paideia:carbon-paideia` skill'inin **yalnız keşif/haritalama** katmanını çalıştır. **Bu komut
...
`/paideia:modul <kod>`'a yönlendir. Hiçbir olgu uydurulmaz; kazanım metni izlenebilir olmalıdır.
