...
> Bu dosya `carbon-paideia` yetkinliğinin **entelektüel çekirdeğidir**. Her modül
...
> `carbon-paideia` motorundaki karşılığını eşler. Kanıt düzeyleri Tier 0–3 (sistematik
...
**Sentez.** Kanıt, `carbon-paideia`'nın mevcut tasarım felsefesini büyük ölçüde
...
- **Tıbbi cihaz veya tedavi değildir.** `carbon-paideia` modülleri eğitim-destek
