...
> `carbon-paideia` çıktısının görsel dilini tanımlar. Tüm token değerleri
...
9. Carbon bileşen → paideia eşlemesi
...
**Carbon tip otoritesi (`@carbon/type@11.61.0`) ↔ paideia ölçeği:**
| Carbon stili | Otorite değeri | Paideia rolü | Paideia değeri | Sapma? |
|---|---|---|---|---|
...
| display | — | `--fs-display` modül başlığı | 2.5rem / 600 / lh 1.2 | paideia eklentisi |
...
Paideia'nın `--tap:48px` dokunma hedefi **Carbon "Large" boyutuyla** örtüşür
...
| Uyarlama | Carbon varsayılan | Paideia değeri | Gerekçe |
|---|---|---|---|
