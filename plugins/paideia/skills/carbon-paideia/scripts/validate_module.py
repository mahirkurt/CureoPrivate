...
# -*- coding: utf-8 -*-
"""
carbon-paideia · Modül Kalite Kapısı Doğrulayıcı (validate_module.py)
====================================================================
...
class Result:
    ...
    def report(self):
        ...
        print(f"\n{BOLD}carbon-paideia · Modül Doğrulama Raporu{RESET}")
        print("="*64)
...
def main():
    ...
    ap=argparse.ArgumentParser(description="carbon-paideia modül doğrulayıcı")
