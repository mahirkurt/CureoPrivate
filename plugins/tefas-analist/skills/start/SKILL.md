...
name: start
description: >-
  TEFAS Uzmanı (tefas-analist) süitine giriş, connector sağlık kontrolü (Borsa MCP +
  fon-mcp) ve doğru moda/skill'e yönlendirme. İlk kez süitle çalışırken, "TEFAS Uzmanı
  ...
  Tetikler — TEFAS Uzmanı başlat, fon analizi nereden başlayayım, "ne yapabilirsin",
  Borsa/fon-mcp bağlı mı, connector kontrolü, kurulum doğrulama.
---

# start — TEFAS Uzmanı oryantasyon & yönlendirme

**Süit:** tefas-analist (capability-cluster) · **Dil:** Türkçe (çıktı), İngilizce (API).
