...
CONVENTIONS = (
    ...
    "(2) NO-FABRICATION / RESTRICTED-SOURCE — katalog kaydı, kayıt-no (fon/kutu/gömlek), künye ve "
    "özet DOĞRUDAN sağlanır; ancak belge GÖRÜNTÜLERİ/tam-metni (BOA/BCA eSatış+on-site; TKGM/ATASE/"
    "İSAM/Süleymaniye/Millet Yazma vd.) ÜRETİLMEZ — yalnız erişim/satın-alma durumu + yol haritası. "
    "Belge içeriği ancak transkripsiyon tezinden (yoktez) veya kullanıcının kendi çalışmasından "
    "doğrulanır. Hiçbir belge metni/görüntüsü uydurulmaz. "
