...
def context_message(ledger: dict) -> str:
    ...
    return (
        ...
        f"{PLUGIN_LABEL} işini yaparken hybrid_query / graph_neighbors / subgraph "
        "bu collection ile çağrılır. Kapsamsız çağrı DENY (paylaşılan korpus "
        "sızıntısı) — bu kural filo geneli ve mutlaktır. "
